...
module.exports.wait = 'img[alt][title]';
    ...
    if (null !== $root) {
        ...
        if (null !== $name) {
            ...
            if (null !== $main) {
                ...
                // var $image = $main.querySelector('div[style*="background-image: url(\\"/upload"]');
                // var $images = $image.parentNode.parentNode.parentNode.nextElementSibling.querySelectorAll('img');
                // var len = $images.length;
                // for (var i = 0; i < len; i++) {
                //     result.images.push(source.site + $images[i].getAttribute('src').trim());
                // }
                // if (null !== $image) {
                //     var m = $image.style.backgroundImage.match(/url\("(.*)"\)/);
                //     if ((m instanceof Array) && 2 == m.length) {
                //         result.images.push(source.site + m[1]);
                //     }   
                // }
