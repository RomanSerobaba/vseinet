...
use AppBundle\Enum\GoodsDecisionDocType;
use Symfony\Component\HttpKernel\Exception\ConflictHttpException;

class GoodsDecisionDocUpdate
{

    /**
     * Обновление документа
     *
     * @param \ReservesBundle\Entity\GoodsDecisionDoc $newDocument регистрируемый документ
     * @param \ReservesBundle\Entity\GoodsDecisionDoc $oldDocument старый регистрируемый документ
     ...
     */
    public static function Update(GoodsDecisionDoc $newDocument, GoodsDecisionDoc $oldDocument, \Doctrine\ORM\entityManager $em, \AppBundle\Entity\User $currentUser)
    {
        ...
        if ($newDocument->getStatusCode() != $oldDocument->getStatusCode()) {
            ...
            $statusQeryText = "
                ...
                from goods_decision_doc_status
                where
