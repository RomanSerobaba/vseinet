...
class GetOrderSummaryQueryHandler extends MessageHandler
{
    public function handle(GetOrderSummaryQuery $query)
    {
        ...
        return new DTO\Cart($products, $discount instanceof DiscountCode ? $discount->getCode() : null, $deliveryCharges ?? 0, $liftingCharges ?? 0, $transportCompanyDeliveryCharges ?? 0, $deliveryToRepresentativeTaxAmount ?? 0, $paymentTypeComissionPercent ?? 0, $paymentTypeName);
    }
}
