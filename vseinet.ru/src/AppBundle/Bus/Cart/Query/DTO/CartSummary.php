...
class CartSummary
{
    ...
    public function __construct(array $products, string $discountCode = NULL, int $deliveryCharges = NULL, int $liftingCharges = NULL, int $transportCompanyDeliveryCharges = NULL, int $deliveryToRepresentativeTaxAmount = NULL, float $paymentTypeComissionPercent = NULL, string $paymentTypeName = NULL)
    {
