...
class SetMainCounteragentCommandHandler extends MessageHandler
{
    public function handle(SetMainCounteragentCommand $command)
    {
        /**
        ...
        $query = $em->createQuery("
            ...
            SET is_main = TRUE 
            WHERE
                supplier_id = :supplier_id AND counteragent_id = :counteragent_id
        ");
        $query->setParameter('supplier_id', $command->id);
