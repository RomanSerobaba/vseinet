...
use SiteBundle\Bus\Catalog\Query\DTO\Filter\Data;
use SiteBundle\Bus\Catalog\Query\DTO\Filter\Range;
...
class QueryString
{
     ...
     */
    public function __construct(EntityManager $em, UserIdentity $user)
    {
        $this->em = $em;
        $this->user = $user;
    }
