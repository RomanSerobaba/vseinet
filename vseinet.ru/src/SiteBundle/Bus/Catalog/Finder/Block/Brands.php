...
use SiteBundle\Bus\Catalog\Query\DTO\Filter\Brand;
...
class Brands
{
    ...
    /**
     * @return array<SiteBundle\Bus\Catalog\Query\DTO\Filter\Brand>
     */
    public static function build(array $brandId2count, EntityManager $em): array 
    {
        ...
        $q = $em->createQuery("
            SELECT 
                NEW SiteBundle\Bus\Catalog\Query\DTO\Filter\Brand (
                    b.id, 
                    b.name
                ),
