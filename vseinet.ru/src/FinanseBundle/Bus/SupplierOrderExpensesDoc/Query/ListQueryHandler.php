...
use FinanseBundle\Bus\SupplierOrderExpensesDoc\Query\DTO\DocumentList;
...
class ListQueryHandler extends MessageHandler
{
    public function handle(ListQuery $query)
    {
        ...
        $queryCount = "
            select
                count(did) as total
            from supplier_order_expenses_doc i
            ";
        ...
        $queryList = "
            ...
            from supplier_order_expenses_doc i". DocumentQueryHelper::buildJoin('i') ."
