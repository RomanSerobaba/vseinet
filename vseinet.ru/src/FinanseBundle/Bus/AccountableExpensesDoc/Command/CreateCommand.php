...
class CreateCommand extends Message
{
     ...
     * @Assert\NotBlank(message="Статья расхода, на которую будут списаны выданные средства, должна быть указана")
     * @Assert\Type(type="integer")
     */
    public $toItemOfExpensesId;

    /**
     * @VIA\Description("Идентификатор оборудования, на которое будут списаны выданные средства")
     * @Assert\Type(type="integer")
     */
