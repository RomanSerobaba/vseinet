 ...
 * @ORM\Entity(repositoryClass="OrderBundle\Repository\ClientOrderRepository")
 */
class ClientOrder
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="delivery_type_code", type="string", length=255)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="call_needed_comment", type="string", length=255, nullable=true)
     */
