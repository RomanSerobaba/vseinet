...
class UpdateDepartmentTypeActivityCommandHandler extends MessageHandler
{
    /**
     * @param UpdateDepartmentTypeActivityCommand $command
     * @throws EntityNotFoundException
     * @throws \Doctrine\ORM\ORMException
     * @throws \Doctrine\ORM\OptimisticLockException
     */
    public function handle(UpdateDepartmentTypeActivityCommand $command)
    {
